...
export const IPC = {
  ...
  TAB_LIST:         'tab:list',
  TAB_UPDATED:      'tab:updated',      // push: main → renderer
  /** Renderer calls this when a webview navigates so main can persist the URL. */
  TAB_UPDATE_META:  'tab:updateMeta',
  /** Renderer registers the webview's webContentsId so main can run JS for AI. */
  TAB_REGISTER_WC:  'tab:registerWc',
